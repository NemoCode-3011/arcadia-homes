    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-arcadia-charcoal shadow-lg py-3" : "bg-transparent py-5"
      ...
      {menuOpen && (
        <div className="lg:hidden bg-arcadia-charcoal px-6 py-4 space-y-4 border-t border-arcadia-bark">
          ...
          <NavLink to="/about" onClick={() => setMenuOpen(false)} className="block text-arcadia-sand hover:text-arcadia-cream text-sm font-medium">About</NavLink>
          <NavLink to="/contact" onClick={() => setMenuOpen(false)} className="block text-arcadia-sand hover:text-arcadia-cream text-sm font-medium">Contact</NavLink>
