...
import AgentSignUpPage from "./pages/admin/AgentSignUpPage"
    ...
    <AuthProvider>
      <PropertiesProvider>
        ...
        <Routes>
          ...
          {/* Protected public routes — must sign up first */}
          ...
          {/* Agent account setup — linked from invite email */}
          <Route path="/admin/agent-signup" element={<AgentSignUpPage />} />
