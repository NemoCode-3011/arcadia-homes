...
const HomePage = () => {
  ...
  const statscards: StatCardData[] = [
    { title: "Total Listings", value: 124, change: "↑ 12 this week" },
    { title: "Properties Sold", value: 40, change: "↑ 3 this month" },
    { title: "For rent", value: 30, change: "↑ 5 this week" },
  ...
  return (
    <div className="p-2 lg:p-6">
      <header className="mb-6">
        <h1 className="text-2xl font-semibold text-arcadia-cream">Good Morning Temilade,</h1>
        <p className="text-sm text-arcadia-sand mt-1">Here's what is happening with Arcadia today</p>
      </header>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
        {statscards.map((stat) => (
          <div className="border w-full h-30 p-6 bg-arcadia-stone rounded-md shadow shadow-arcadia-moss">
            <StatCard
              key={stat.title}
              title={stat.title}
              value={stat.value}
      ...
      <div className="mt-10 flex justify-between">
        ...
        <h1 onClick={()=> navigate("/properties")} className="text-md text-arcadia-cream font-semibold mt-3 cursor-pointer">Explore more →</h1>
      </div>
      ...
      <div className="grid grid-cols-1  lg:grid-cols-2  gap-6 mt-8">
        ...
        <div className="bg-arcadia-stone rounded-xl p-6">
          <h3 className="text-arcadia-cream font-semibold mb-4">
            Monthly Listings
          </h3>
